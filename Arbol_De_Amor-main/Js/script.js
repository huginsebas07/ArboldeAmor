...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Te amo más de lo que las palabras pueden expresar.";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-05-04T00:00:00'); 
  ...
  function update() {
    ...
    container.innerHTML =
      ...
      `No sé a dónde vamos, pero estar contigo me hace muy feliz, y eso es suficiente.<b></b>`;
